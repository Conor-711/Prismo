# YouTube Smart Voice Top / Bottom 报告（2026-07-11）
...
YouTube SV 已完成平台内 Top/Bottom 正式分组并接入产品导出。
...
| 分组 | 作者 | 平均平台 SV | 平均 Global SV | 平均 n_eff | 平均已结算 call | 平均覆盖标的 | 平均最大单标的权重 |
|---|---:|---:|---:|---:|---:|---:|---:|
...
4. 高波动、小盘和 meme stock 可能放大方向性超额，应结合集中度、标的分段 SV 和置信区间阅读。
