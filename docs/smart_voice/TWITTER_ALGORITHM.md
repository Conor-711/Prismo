# Smart Voice Twitter Algorithm

## Scope

Source key: `x`.

Twitter is the high-frequency, short-form Smart Voice source. It is best for timely calls, tactical reversals, flow/momentum setups, and direct ticker commentary.
