# Smart Account Xueqiu Algorithm
...
The first version uses a two-stage pool instead of treating popularity as Score:
...
4. After the one-year backfill, require at least 8 US-equity-relevant posts, 8 settled calls, and `n_eff >= 5` for formal Score qualification.
