...
def test_realtime_collections_atomically_override_money_and_derived_intelligence() -> None:
    with TemporaryDirectory() as directory:
        ...
        try:
            ...
            live_money_evidence = deepcopy(collections["smart-money-evidence"][0])
            live_money_evidence["cumulativeEntryNotional"] = 123_456
            ...
            result = realtime.publish(
                {
                    ...
                    "smart-money-evidence": [live_money_evidence],
            ...
            assert repository.smart_money_evidence(live_money_evidence["accountId"])[0]["cumulativeEntryNotional"] == 123_456
...
def test_live_checkpoint_rejects_partially_written_collection() -> None:
    with TemporaryDirectory() as directory:
        ...
        payloads = {
            ...
            "smart-money-evidence": [{"id": "evidence"}],
