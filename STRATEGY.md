# bSmart 产品策略：aha moment 与主打功能

> 目的：综合调研主流美股网站，定位 bSmart 作为「Reddit 美股垂类分析站」的**独有价值**，据此优化 UX 并确定主打功能。核心原则：**最大化利用 Reddit 社区信息**去满足投资者的真实需求。
...
| 宏观 | FRED | 美联储宏观数据 |
| **社交 / 散户情绪（bSmart 的赛道）** | StockTwits、QuiverQuant（WSB 提及分）、**ApeWisdom / SwaggyStocks / YoloStocks** | **Reddit/WSB 提及量 + 简单词袋情绪** |
