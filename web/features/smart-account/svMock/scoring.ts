...
export function getCreatorSmartVoice(channelId: string, name?: string): SvInvestor {
  ...
  return {
    ...
    rationaleZh: "Mock Score：根据该频道已收录视频构造的作者画像占位，等待真实 Score 管线替换。",
    rationaleEn: "Mock Score profile based on collected channel videos, pending the real Score pipeline.",
  };
}
