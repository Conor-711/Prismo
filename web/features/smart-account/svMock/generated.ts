...
function normalizeRealInvestor(value: unknown): SvInvestor | null {
  ...
  return {
    ...
    rationaleZh: String(raw.rationaleZh || "真实 Score v0：根据已结构化 call 的历史结算结果生成。"),
    rationaleEn: String(raw.rationaleEn || "Real Score v0 generated from settled structured calls."),
  };
}
