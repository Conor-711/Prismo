  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-y-3 border-b border-line/70 pb-4 sm:grid-cols-3 xl:grid-cols-6">
        ...
        <Stat label={zh ? "净 Score 贡献" : "Net Score contribution"} value={`${stats.netContribution >= 0 ? "+" : ""}${stats.netContribution.toFixed(2)}`} tone={stats.netContribution >= 0 ? "text-bull" : "text-bear"} />
