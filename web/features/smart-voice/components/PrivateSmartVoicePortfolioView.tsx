...
import type { PrivateSmartVoicePortfolioBacktest } from "@/server/queries/privateSmartVoiceExperiment";
...
export function PrivateSmartVoicePortfolioView({
  backtest,
  zh,
}: {
  backtest: PrivateSmartVoicePortfolioBacktest;
  zh: boolean;
}) {
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="mt-0.5 text-[9px] text-neutral-600">
              {zh ? "已计入往返 10 bps 成本；无有效观点时持有现金。" : "Includes 10 bps round-trip cost; cash when inactive."}
            </p>
          </div>
