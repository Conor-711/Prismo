...
const THEME_INIT = `try{var d=document.documentElement;var t=localStorage.getItem('prismo:theme');var dark=t==='dark';if(dark){d.classList.add('dark')}else{d.classList.remove('dark')}var sb=localStorage.getItem('prismo:sidebar');if(sb){d.setAttribute('data-sb',sb)}var m=document.querySelector('meta[name=theme-color]');if(m){m.setAttribute('content',dark?'#0b0b0d':'#f4f5f7')}var lp=location.pathname.split('/')[1];var LM={zh:'zh-CN',en:'en',ja:'ja',ko:'ko'};if(LM[lp]){d.lang=LM[lp]}}catch(e){}`;
...
const SITE_TITLE = "Prismo · Reddit 美股舆情情报";
const SITE_DESC =
