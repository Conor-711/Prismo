...
import { ChangeBars, HotList, MiniTrend } from "@/features/region";
import { Arrow, Counter, Counters, Module, SigmaBadge, bi, flag } from "@/shared/ui/detailBits";
import { ViewportWorkspace } from "@/shared/layout/ViewportWorkspace";
import { getGrRegionSummary } from "@/server/queries/globalQueries";
import { getRegionMock } from "@/shared/market/mockDetail";
import { REGION_ORDER, regionLabel, regionSource, regionColor, isRegion } from "@/shared/market/regions";
