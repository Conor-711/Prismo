...
import { SV_HORIZONS, type SvBoard, type SvDistribution, type SvHorizon, type SvInvestor } from "@/lib/svMock";
...
function StatCell({ label, value, tone = "text-cream" }: { label: string; value: string; tone?: string }) {
  return (
...
function DistributionPanel({ board, zh }: { board: SvBoard; zh: boolean }) {
...
function AlertsPanel({ board, zh }: { board: SvBoard; zh: boolean }) {
...
function TypePanel({ board, zh }: { board: SvBoard; zh: boolean }) {
...
function RankingPanel({ board, zh }: { board: SvBoard; zh: boolean }) {
...
function TypicalPanel({ board, zh }: { board: SvBoard; zh: boolean }) {
  const cases = useMemo(() => {
