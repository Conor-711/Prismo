...
用法（需 .env 里有 DEEPSEEK_API_KEY，走 LOW 档 deepseek-v4-flash）：
    python -m pipeline.manage translate            # 翻译所有缺失译文的内容
    python -m pipeline.manage translate --limit 200
    python -m pipeline.manage translate --only posts,analysis,comments
